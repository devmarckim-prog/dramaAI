...
const arenaData = {
      ...
      pct: 100,
      ppl: [
        { item: "최신형 스마트폰", scene: "재헌의 촬영장 모니터링 씬", revenue: 50000000, industry: "IT/가전" },
        { item: "기능성 에너지 드링크", scene: "편집실 밤샘 작업 씬", revenue: 30000000, industry: "식음료" },
        { item: "디자이너 브랜드 협찬", scene: "서영의 투자자 미팅 씬", revenue: 45000000, industry: "패션" },
        { item: "프리미엄 커피 브랜드", scene: "스튜디오 카페 아침 씬", revenue: 25000000, industry: "식음료" },
        { item: "노트북 컴퓨터", scene: "편집팀 작업 장면", revenue: 55000000, industry: "IT/가전" },
        { item: "명품 시계 브랜드", scene: "서영의 비즈니스 미팅 씬", revenue: 40000000, industry: "패션/액세서리" }
      ],
      genre: "로맨틱 코미디",
      stats: {
        net: 3600000000,
      ...
      conflicts: [
        { desc: "예술지상주의 PD와 데이터 중심 전략가의 크리에이티브 방향성을 둘러싼 사사건건 충돌.", type: "가치관 충돌", character: "조재헌 vs 오서영" },
        { desc: "과거 대역전극 실패에 대한 트라우마와 자신의 감각에 대한 불안함 사이의 투쟁.", type: "내적 갈등", character: "조재헌" },
        { desc: "완벽해야 한다는 강박과 처음 느끼는 재헌에 대한 낯선 감정 사이의 혼란.", type: "내적 갈등", character: "오서영" },
        { desc: "라이벌 이다인의 교묘한 방해 공작과 대형 플랫폼의 갑질로 인한 제작 중단 위기.", type: "외부 압박", character: "아레나 스튜디오 vs 이다인" }
      ],
      isVisible: true,
      characters: [
        { age: "34세", job: "전 PD / 공동대표", name: "조재헌", role: "남주", gender: "남성", personality: "직관과 감각으로 승부. 이야기 중심. 가끔 무모할 정도로 예술적 감수성을 앞세움.", looks: "캐주얼, 항상 목에 걸려있는 소니 헤드폰", background: "스튜디오 룰루랄라의 대표 PD였으나 대역전극 실패로 떨어짐. 그 이후 자신의 감각을 믿지 못하는 상황.", arc: "서영과의 만남을 통해 자신의 감각을 다시 믿게 되고, 감각과 전략의 조화를 배움." },
        { age: "32세", job: "전 대행사 대표 / 공동대표", name: "오서영", role: "여주", gender: "여성", personality: "숫자와 전략으로 승부. 완벽주의. 감정보다 효율을 중요시하는 냉철한 전략가.", looks: "세련된 오피스룩, 흐트러짐 없는 단발", background: "대행사 대표였으나 한 건의 실패로 좌절. 완벽함으로 모든 것을 통제하려 함.", arc: "재헌을 만나면서 감정의 가치를 깨닫고, 완벽함 대신 진정함을 선택하게 됨." },
        { age: "28세", job: "막내 PD", name: "한태오", role: "조연", gender: "남성", personality: "MZ 감각의 소유자. 엉뚱하지만 유행의 흐름을 본능적으로 읽어내는 아이디어맨.", looks: "트렌디한 스트릿 패션", background: "두 대표보다 한 세대 아래. 현재 감각과 미래 트렌드에 민감함.", arc: "두 대표의 충돌을 관찰하면서 성장. 마지막 위기에서 핵심 아이디어를 제시." },
        { age: "29세", job: "경쟁사 PM", name: "이다인", role: "조연", gender: "여성", personality: "서영의 라이벌. 과거 서영에게 밀린 트라우마가 있음. 재헌의 감각을 이용해 서영을 곤란하게 만들려 함.", looks: "화려하고 도발적인 스타일", background: "서영과는 대행사에서 경쟁 관계였음. 서영에게 밀려난 후 현재 경쟁사로 이직. 복수심 강함.", arc: "재헌을 유혹하고 서영을 괴롭히려 했으나, 결국 둘의 진정성 앞에 패배." }
      ],
      themes: ["감각과 전략의 조화", "완벽함과 진정함", "예술과 상품성의 경계", "혼자가 아닌 함께", "상처에서 성장으로"],
...
export let DIRECTORS_ARENA_SAMPLE = ${JSON.stringify(arenaData, null, 2)};

export let SEOUL_NIGHT_SAMPLE = ${JSON.stringify(seoulData, null, 2)};
...
fs.writeFileSync('c:\\Users\\happy\\Downloads\\Gravity APP\\디렉터즈 아레나\\js\\modules\\samples.js', fileContent, 'utf8');
console.log('Successfully updated samples.js');
