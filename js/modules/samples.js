  ...
  "episodes": [
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "재헌과 서영의 최악의 첫만남. 계약조건을 두고 설전을 벌임.",
          "time": "낮",
          "place": "INT. 아레나 스튜디오 - 낮"
        },
        {
          "num": 2,
          "desc": "각자 술을 마시며 상대방 뒷담화를 하다가 우연히 마주치고 외면함.",
          "time": "저녁",
          "place": "EXT. 합정동 거리 - 저녁"
        },
        {
          "num": 3,
          "desc": "한태오가 두 사람 사이를 중재하려다 실패. 투자사 대표와의 긴급 전화 회의 장면.",
          "time": "밤",
          "place": "INT. 스튜디오 사무실 - 밤"
        }
      ]
    },
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "화이트보드를 가득 채운 서영의 데이터와 재헌의 콘셉트 드로잉이 충돌함. 감정적인 갈등이 절정.",
          "time": "낮",
          "place": "INT. 회의실 - 오전"
        },
        {
          "num": 2,
          "desc": "서영이 퇴근하려다 재헌의 컴퓨터에서 의문의 폴더를 열어봄.",
          "time": "밤",
          "place": "INT. 대표실 - 밤"
        },
        {
          "num": 3,
          "desc": "태오가 두 대표의 타협점을 찾는 새로운 기획안을 제시.",
          "time": "새벽",
          "place": "INT. 편집실 - 새벽"
        }
      ]
    },
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "심사위원들과 참가자들 사이의 팽팽한 긴장감과 돌발 상황.",
          "time": "낮",
          "place": "INT. 오디션 세트장 - 낮"
        },
        {
          "num": 2,
          "desc": "서영이 참가자를 몰아세우며 재헌을 방어하는 의외의 모습.",
          "time": "저녁",
          "place": "INT. 복도 - 저녁"
        },
        {
          "num": 3,
          "desc": "사건 이후 촬영장에서 보내는 시간. 서로를 바라보는 눈이 조금씩 달라짐.",
          "time": "밤",
          "place": "INT. 라운지 - 밤"
        }
      ]
    },
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "경쟁사 이다인이 아레나 스튜디오를 방문. 재헌을 향한 노골적인 친근감.",
          "time": "낮",
          "place": "INT. 아레나 스튜디오 로비 - 낮"
        },
        {
          "num": 2,
          "desc": "서영의 불안정한 감정 상태.",
        ...
        {
          "num": 3,
          "desc": "투자사 대표와의 미팅. 성과 압박이 가중됨.",
          "time": "저녁",
          "place": "INT. 회의실 - 저녁"
        },
        {
          "num": 4,
          "desc": "서영이 엘리베이터에서 이다인과 만남.",
          "time": "저녁",
          "place": "INT. 엘리베이터 - 저녁"
        }
      ]
    ...
    },
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "업무적으로만 대하는 두 대표.",
          "time": "낮",
          "place": "INT. 회의실 - 낮"
        },
        {
          "num": 2,
          "desc": "서영의 과거를 추적하는 장면.",
          "time": "밤",
          "place": "INT. 서영의 집 - 밤"
        },
        {
    ...
    },
    {
      ...
      "scenes": [
        {
          "num": 1,
          "desc": "플랫폼 대표의 갑질. 중단 요구와 예산 삭감.",
          "time": "낮",
          "place": "INT. 회의실 - 낮"
        },
        {
          "num": 2,
          "desc": "스튜디오 전 직원이 모여 위기 상황을 공유.",
          "time": "낮",
          "place": "INT. 스튜디오 라운지 - 낮"
        },
        {
          "num": 3,
          "desc": "밤새 만든 새로운 기획안.",
    ...
    },
    {
      ...
      "scenes": [
        ...
        },
        {
          ...
          "desc": "오디션 성공 발표.",
          "time": "저녁",
          "place": "INT. 스튜디오 라운지 - 저녁"
        },
        {
          "num": 4,
          "desc": "파티가 끝난 후 둘만 남은 스튜디오.",
          "time": "밤",
          "place": "INT. 스튜디오 옥상 - 밤"
        },
        {
          "num": 5,
          "desc": "1년 후. 두 대표가 함께 시즌 2를 기획하는 모습.",
          "time": "낮",
          "place": "INT. 새로워진 대표실 - 낮"
        }
      ]
    }
  ],
  ...
  "conflicts": [
    {
      "type": "내면의 갈등",
      "character": "강도진",
      "desc": "개인적 복수와 대의적 정의 사이에서의 고뇌."
    },
    {
      "type": "추격전",
      "character": "강도진 vs 경찰",
      "desc": "이수연의 포위망이 점점 좁혀오는 상황."
    }
  ],
  "stats": {
    "budget": 12000000000,
